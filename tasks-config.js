(function () {
  ...
  window.TASKS_CONFIG = {
    ...
    weeklies: [
      ...
      t(
        ...
        { reset: 'weekly', alertDaysBeforeReset: 1 }
      ),
    ...
    monthlies: [
      ...
      t(
        ...
        { reset: 'monthly', alertDaysBeforeReset: 1 }
      ),
  ...
  window.TASKS_CONFIG.dailies = window.TASKS_CONFIG.dailies.map(task => Object.assign({ reset: 'daily', alertDaysBeforeReset: 0 }, task));
  window.TASKS_CONFIG.gathering = window.TASKS_CONFIG.gathering.map(task => Object.assign({ reset: 'daily', alertDaysBeforeReset: 0 }, task));
})();