...
type TrackerView = { id: string; label: string };
type TrackerTask = { id: string; reset?: string; children?: TrackerTask[]; childRows?: TrackerTask[] };
type TrackerSection = { id: string; game: 'rs3' | 'osrs'; displayOrder?: number; resetFrequency?: string; items?: TrackerTask[]; groups?: any[] };
type TrackerPage = { id: string; game: 'rs3' | 'osrs'; route: string; displayOrder?: number; availableViews: TrackerView[]; sections: string[] };
