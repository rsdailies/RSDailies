import { GAMES, setSelectedGame } from '../../shared/state/game-context.js';

/**
 * Landing Page Renderer
 * 
 * Renders the game selection screen when no game is selected.
 * Uses existing CSS tokens from layout.css.
 */
export function renderLandingPage(deps) {
