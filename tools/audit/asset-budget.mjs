...
assert.ok(cssAssets.length > 0, 'No built CSS assets found in dist/client/_astro.');
...
console.log(
	`Asset budget audit passed. Largest CSS bundle: ${largest.name} (${(largest.size / 1024).toFixed(1)} KB raw).`,
);
